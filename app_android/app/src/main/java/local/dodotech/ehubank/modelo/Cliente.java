...
public class Cliente implements Serializable{
     ...
     */
    public Cliente(String nombre, String apellidos, Date fechaNacimiento, String direccion, String telefonoContacto, String identificador, String clave, String pathImagen) {
        this.nombre = nombre;
    ...
    /**
     * Devuelve la imagen de un perfil de usuario
     * @return Imagen de un usuario
     */
