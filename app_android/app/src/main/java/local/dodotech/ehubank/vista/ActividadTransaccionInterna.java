...
public class ActividadTransaccionInterna extends AppCompatActivity {
    ...
    public void evtRealizarTransaccionInterna(View v){
        ...
        boolean transferenciaCompleta = ControladorCuentaBancaria.getControladorCuentaBancaria().realizarTransferencia(cuentaOrigen, cuentaDestino, Float.parseFloat(cantidad), "Transferencia interna");
